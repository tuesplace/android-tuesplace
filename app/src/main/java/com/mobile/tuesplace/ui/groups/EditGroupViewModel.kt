...
class EditGroupViewModel(private val groupUseCase: GetGroupUseCase, private val deleteGroupUseCase: DeleteGroupUseCase): ViewModel() {
    ...
    private val _deleteGroupUiStateFlow = MutableStateFlow<DeleteGroupUiState>(DeleteGroupUiState.Empty)
