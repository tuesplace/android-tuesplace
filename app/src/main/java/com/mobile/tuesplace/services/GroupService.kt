...
interface GroupService {
    suspend fun createGroup(createGroupData: GroupData, createGroupCallback: GroupCallback<Unit>)
    suspend fun getGroups(groupCallback: GroupCallback<List<GroupResponseData>>)
    suspend fun getGroup(groupCallback: GroupCallback<GroupResponseData>, groupId: String)
